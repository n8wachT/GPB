...
#NOT IMPLEMENTED, THIS MODULE IS UNFINISHED AND IS MORE COMPLEX THAN THE ORIGINAL ONE.
#PLEASE DON'T USE UNLESS YOU KNOW MY BOT MORE THAN ME.

#CLASS THAT HANDLE EVERY POSSIBLE EVENT
#DON'T USE IT, THIS WILL CREATE A NEW WORLD WAR/NUCLEAR EXPLOSION/ETC.  jk.
class Plugin:
